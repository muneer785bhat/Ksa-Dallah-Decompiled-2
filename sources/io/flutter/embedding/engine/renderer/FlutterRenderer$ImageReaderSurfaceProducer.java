...
final class FlutterRenderer$ImageReaderSurfaceProducer implements TextureRegistry$SurfaceProducer, TextureRegistry$ImageConsumer, n {
    ...
    public FlutterRenderer$ImageReaderSurfaceProducer(i iVar, long j6) {
        this.this$0 = iVar;
        this.id = j6;
    }
    ...
    private ImageReader createImageReader33() {
        B.r();
        ImageReader.Builder builderI = B.i(this.requestedWidth, this.requestedHeight);
        builderI.setMaxImages(7);
        ...
        synchronized (this.lock) {
            try {
                if (!this.createNewReader) {
                    ...
                    if (eVarPeekLast.f18281a.getSurface().isValid()) {
                        return eVarPeekLast;
                    }
                }
    ...
    private void releaseInternal() {
        ...
        this.released = true;
        this.this$0.h(this);
        this.this$0.f18318g.remove(this);
    }
    ...
    public Image acquireLatestImage() {
        ...
        Image image = cVarDequeueImage.f18278a;
    ...
    public c dequeueImage() {
        ...
        if (z2) {
            this.this$0.f18316e.post(new b(this, 0));
        }
        return cVar;
    }
    ...
    public Surface getSurface() {
        return getActiveReader().f18281a.getSurface();
    }
    ...
    public void onImage(ImageReader imageReader, Image image) {
        ...
        synchronized (this.lock) {
            ...
            ArrayDeque arrayDeque = orCreatePerImageReader.f18282b;
            if (orCreatePerImageReader.f18283c) {
                cVar = null;
            } else {
                ...
                while (arrayDeque.size() > 2) {
                    ((c) arrayDeque.removeFirst()).f18278a.close();
                }
                cVar = cVar2;
            }
        }
    ...
    public void pruneImageReaderQueue() {
        ...
        while (this.imageReaderQueue.size() > 1 && (eVarPeekFirst = this.imageReaderQueue.peekFirst()) != null) {
            ImageReader imageReader = eVarPeekFirst.f18281a;
            ArrayDeque arrayDeque = eVarPeekFirst.f18282b;
            if (!arrayDeque.isEmpty() || eVarPeekFirst.d.lastReaderDequeuedFrom == eVarPeekFirst) {
                return;
            }
            this.imageReaderQueue.removeFirst();
            this.perImageReaders.remove(imageReader);
            eVarPeekFirst.f18283c = true;
            imageReader.close();
            arrayDeque.clear();
        }
    }
    ...
    public void setSize(int i5, int i7) {
        int iMax = Math.max(1, i5);
        int iMax2 = Math.max(1, i7);
