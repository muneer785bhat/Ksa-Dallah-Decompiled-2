...
public enum EnumC2671x {
    ...
    static {
        ...
        for (EnumC2671x enumC2671x : values()) {
            if (map.put(Character.valueOf(enumC2671x.E), enumC2671x) != null) {
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(enumC2671x)));
            }
        }
