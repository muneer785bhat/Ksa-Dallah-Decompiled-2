...
public abstract class X0 {
    ...
    public static int b(String str) {
                        ...
                        if (cCharAt2 < 2048) {
                            ...
                            if (cCharAt2 >= 55296 && cCharAt2 <= 57343) {
                                if (Character.codePointAt(str, i7) < 65536) {
                                    throw new W0(C1893rK.a(length2, i7, (byte) 32, "Unpaired surrogate at index ", " of "));
                                }
                                i7++;
                            }
                        }
        ...
        StringBuilder sb = new StringBuilder(String.valueOf(j6).length() + 34);
    ...
    public static String d(byte[] bArr, int i5, int i7) throws C2627s0 {
        if (i7 == 0) {
            return "";
        }
        ...
        while (i5 < i8) {
            ...
            if (b8 >= 0) {
                ...
                if (b8 >= -32) {
                    if (b8 >= -16) {
                        if (i10 >= i8 - 2) {
                            throw new C2627s0("Protocol message had invalid UTF-8.");
                        }
                        byte b10 = bArr[i10];
                        int i11 = i5 + 3;
                        byte b11 = bArr[i5 + 2];
                        i5 += 4;
                        byte b12 = bArr[i11];
                        if (!AbstractC2482c0.e(b10)) {
                            if ((((b10 + 112) + (b8 << 28)) >> 30) == 0 && !AbstractC2482c0.e(b11) && !AbstractC2482c0.e(b12)) {
                ...
                i5 += 2;
                byte b15 = bArr[i10];
                if (b8 < -62 || AbstractC2482c0.e(b15)) {
                    throw new C2627s0("Protocol message had invalid UTF-8.");
                }
