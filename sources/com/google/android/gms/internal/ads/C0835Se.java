...
public final class C0835Se {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final InterfaceC0687Je f9870a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final Context f9871b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final BinderC0915Xe f9872c;
    public final long d;

    public C0835Se(Context context, String str) {
        C0243n c0243n = C0247p.f3016g.f3018b;
        BinderC0769Oc binderC0769Oc = new BinderC0769Oc();
        c0243n.getClass();
        InterfaceC0687Je interfaceC0687Je = (InterfaceC0687Je) new C0219b(c0243n, context, str, binderC0769Oc).d(context, false);
        this.d = System.currentTimeMillis();
        new AtomicLong();
        this.f9871b = context.getApplicationContext();
        new AtomicReference(str);
        this.f9870a = interfaceC0687Je;
        this.f9872c = new BinderC0915Xe();
    }
    ...
    public static void a(Context context, String str, G2.g gVar, I2.a aVar) {
        ...
        if (((Boolean) AbstractC1631ma.f13518k.r()).booleanValue()) {
            if (((Boolean) N2.r.f3022e.f3025c.a(M9.Cc)).booleanValue()) {
                R2.c.f3765b.execute(new D3.B0(context, str, gVar, aVar, 15));
                return;
            }
        }
        R2.k.a("Loading on UI thread");
        new C0835Se(context, str).c(gVar.f2000a, aVar);
    }

    public final void b(Activity activity, G2.o oVar) {
        BinderC0915Xe binderC0915Xe = this.f9872c;
        ...
        try {
            InterfaceC0687Je interfaceC0687Je = this.f9870a;
    ...
    public final void c(N2.F0 f02, I2.a aVar) {
        try {
            ...
            if (interfaceC0687Je != null) {
                f02.f2900m = this.d;
                interfaceC0687Je.a4(N2.i1.a(this.f9871b, f02), new BinderC0867Ue(aVar, this, 0));
            }
        } catch (RemoteException e6) {
            R2.k.i("#007 Could not call remote method.", e6);
        }
