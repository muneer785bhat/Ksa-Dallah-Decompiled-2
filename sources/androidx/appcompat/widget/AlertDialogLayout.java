...
public class AlertDialogLayout extends AbstractC3143F {
    ...
    */
    ...
    public final void onMeasure(int i5, int i7) {
        ...
        if (view2 != null) {
            int i10 = paddingBottom - iH;
            int iMin = Math.min(i9, measuredHeight);
            if (iMin > 0) {
                i9 -= iMin;
                iH += iMin;
            }
            view2.measure(i5, View.MeasureSpec.makeMeasureSpec(iH, 1073741824));
            paddingBottom = i10 + view2.getMeasuredHeight();
            iCombineMeasuredStates = View.combineMeasuredStates(iCombineMeasuredStates, view2.getMeasuredState());
        }
        if (view3 != null && i9 > 0) {
            view3.measure(i5, View.MeasureSpec.makeMeasureSpec(measuredHeight2 + i9, mode));
        ...
        int i12 = i7;
        alertDialogLayout.setMeasuredDimension(View.resolveSizeAndState(alertDialogLayout.getPaddingRight() + alertDialogLayout.getPaddingLeft() + iMax, i5, iCombineMeasuredStates), View.resolveSizeAndState(paddingBottom, i12, 0));
        if (mode2 != 1073741824) {
            ...
            while (i13 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((ViewGroup.MarginLayoutParams) c3142e).width == -1) {
                        int i14 = ((ViewGroup.MarginLayoutParams) c3142e).height;
                        ((ViewGroup.MarginLayoutParams) c3142e).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i12, 0);
                        ((ViewGroup.MarginLayoutParams) c3142e).height = i14;
                    }
                }
                i13++;
