...
public final class ScheduledExecutorServiceC0420f implements ScheduledExecutorService, AutoCloseable {
    public final ExecutorService E;
    public final ScheduledExecutorService F;

    public ScheduledExecutorServiceC0420f(ExecutorService executorService, ScheduledExecutorService scheduledExecutorService) {
    ...
    public final ScheduledFuture schedule(Runnable runnable, long j6, TimeUnit timeUnit) {
        return new ScheduledFutureC0422h(new B2.i(this, runnable, j6, timeUnit, 1));
    }

    @Override // java.util.concurrent.ScheduledExecutorService
    public final ScheduledFuture scheduleAtFixedRate(Runnable runnable, long j6, long j7, TimeUnit timeUnit) {
        return new ScheduledFutureC0422h(new C0417c(this, runnable, j6, j7, timeUnit, 0));
    }

    @Override // java.util.concurrent.ScheduledExecutorService
    public final ScheduledFuture scheduleWithFixedDelay(Runnable runnable, long j6, long j7, TimeUnit timeUnit) {
        return new ScheduledFutureC0422h(new C0417c(this, runnable, j6, j7, timeUnit, 1));
    }
    ...
    public final Object invokeAny(Collection collection, long j6, TimeUnit timeUnit) {
        return this.E.invokeAny(collection, j6, timeUnit);
    }

    @Override // java.util.concurrent.ScheduledExecutorService
    public final ScheduledFuture schedule(Callable callable, long j6, TimeUnit timeUnit) {
        return new ScheduledFutureC0422h(new B2.i(this, callable, j6, timeUnit, 2));
    }
