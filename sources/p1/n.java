...
public abstract class n {
    ...
    public static final b f3239a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final b f3240b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final b f3241c;
    public static final b d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final b f3242e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public static final b f3243f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public static final m f3244g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public static final b f3245h;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public static final b f3246i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public static final b f3247j;
    ...
    static {
        ...
        f3239a = new b(2, "WEB_MESSAGE_ARRAY_BUFFER", "WEB_MESSAGE_ARRAY_BUFFER");
        ...
        f3240b = new b(3, "GET_WEB_VIEW_CLIENT", "GET_WEB_VIEW_CLIENT");
        ...
        f3241c = new b(2, "MULTI_PROCESS", "MULTI_PROCESS_QUERY");
        new b(6, "FORCE_DARK", "FORCE_DARK");
        new b(2, "FORCE_DARK_STRATEGY", "FORCE_DARK_BEHAVIOR");
        d = new b(2, "WEB_MESSAGE_LISTENER", "WEB_MESSAGE_LISTENER");
        f3242e = new b(2, "DOCUMENT_START_SCRIPT", "DOCUMENT_START_SCRIPT:1");
        new b(2, "PROXY_OVERRIDE_REVERSE_BYPASS", "PROXY_OVERRIDE_REVERSE_BYPASS");
        f3243f = new b(2, "GET_VARIATIONS_HEADER", "GET_VARIATIONS_HEADER");
        ...
        int i5 = 0;
        new m(i5, "USER_AGENT_METADATA_FORM_FACTORS", "USER_AGENT_METADATA");
        f3244g = new m(1, "MULTI_PROFILE", "MULTI_PROFILE");
        ...
        f3245h = new b(2, "MUTE_AUDIO", "MUTE_AUDIO");
        ...
        new b(2, "BACK_FORWARD_CACHE_SETTINGS", "BACK_FORWARD_CACHE_SETTINGS");
        new b(2, "DELETE_BROWSING_DATA", "WEB_STORAGE_DELETE_BROWSING_DATA");
        new m(2, "PREFETCH_URL_V5", "PREFETCH_URL_V5");
        new b(2, "IMPLEMENTATION_ONLY_FEATURE", "ASYNC_WEBVIEW_STARTUP");
        new b(2, "IMPLEMENTATION_ONLY_FEATURE", "ASYNC_WEBVIEW_STARTUP_ASYNC_STARTUP_LOCATIONS");
        new b(2, "DEFAULT_TRAFFICSTATS_TAGGING", "DEFAULT_TRAFFICSTATS_TAGGING");
        new b(2, "PRERENDER_URL_V2", "PRERENDER_URL_V3");
        ...
        new b(2, "NAVIGATION_LISTENER_V1", "WEB_VIEW_NAVIGATION_LISTENER_V1");
        f3246i = new b(2, "PROVIDER_WEAKLY_REF_WEBVIEW", "PROVIDER_WEAKLY_REF_WEBVIEW");
        f3247j = new b(2, "PAYMENT_REQUEST", "PAYMENT_REQUEST");
        new b(2, "WEBVIEW_BUILDER_EXPERIMENTAL_V1", "WEBVIEW_BUILDER_V1");
        new b(2, "COOKIE_INTERCEPT", "COOKIE_INTERCEPT");
        new b(2, "WARM_UP_RENDERER_PROCESS", "WARM_UP_RENDERER_PROCESS");
        new b(2, "ORIGIN_MATCHED_HEADERS", "EXTRA_HEADER_FOR_ORIGINS");
        new b(2, "CUSTOM_REQUEST_HEADERS", "CUSTOM_REQUEST_HEADERS");
        new i();
        new i();
        new i();
        new b(2, "PRECONNECT", "PRECONNECT");
        new b(2, "ADD_QUIC_HINTS", "ADD_QUIC_HINTS_V1");
        new b(2, "HYPERLINK_CONTEXT_MENU_ITEMS", "HYPERLINK_CONTEXT_MENU_ITEMS");
    }
