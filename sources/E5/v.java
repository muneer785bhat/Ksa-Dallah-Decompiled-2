...
public final class v implements l {
    ...
    public static final Charset f17218a = Charset.forName("UTF8");

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final v f17219b = new v();
    ...
    public static String c(ByteBuffer byteBuffer) {
        ...
        return new String(bArrArray, iArrayOffset, iRemaining, f17218a);
    }
    ...
    public static ByteBuffer d(String str) {
        ...
        byte[] bytes = str.getBytes(f17218a);
