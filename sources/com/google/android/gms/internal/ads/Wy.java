...
public final class Wy {
    ...
    public final ExecutorService f10719b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final Ny f10720c;
    public final Vy d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public final C1560lA f10721e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public final NB f10722f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final HashMap f10723g = new HashMap();

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public final long f10724h;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public final File f10725i;
    ...
    public DexClassLoader f10728l;

    public Wy(Context context, ExecutorService executorService, Ny ny, Vy vy, File file, C1560lA c1560lA, long j6, NB nb) {
        this.f10718a = context;
        this.f10719b = executorService;
        this.f10720c = ny;
        this.d = vy;
        this.f10721e = c1560lA;
        this.f10722f = nb;
        this.f10725i = new File(file, "rbp");
        this.f10724h = j6;
    }
    ...
    /* JADX WARN: Not initialized variable reg: 0, insn: 0x027f: INVOKE (r0 I:com.google.android.gms.internal.ads.kA) VIRTUAL call: com.google.android.gms.internal.ads.kA.c():void A[Catch: all -> 0x027d, MD:():void (m), TRY_ENTER] (LINE:640), block:B:117:0x027f */
    public final synchronized void a() {
        ...
        try {
            C1506kA c1506kAA = this.f10721e.a(201);
            try {
                c1506kAA.a();
                try {
                    try {
                        bArrY = DA.y("yaNxj0mI8YelwGOFzdFTHcA4V/Zl8kT12vjpTmCarA0=", false);
                    } catch (IllegalArgumentException e6) {
                        throw new Uy(e6);
                    }
                } catch (Uy e7) {
                    throw new C1118cy(e7);
                }
            } catch (C1118cy e8) {
                c1506kAA.b(e8);
            } catch (Throwable th) {
            ...
            ByteBuffer.wrap(bArrY, 4, 16).get(bArr);
            for (int i5 = 0; i5 < 16; i5++) {
                bArr[i5] = (byte) (bArr[i5] ^ 68);
            }
            this.f10727k = bArr;
            try {
                File file = this.f10725i;
                file.mkdirs();
                    ...
                    if (!file5.exists()) {
                        try {
                            ...
                            if (length <= 0) {
                                ...
                                try {
                                    try {
                                        if (fileInputStream.read(bArr3) <= 0) {
                                            ...
                                            C1342h6 c1342h6D = C1342h6.D(bArr3, EK.f6950b);
                                            if ("1779306227211".equals(new String(c1342h6D.B().a())) && Arrays.equals(c1342h6D.A().a(), this.f10720c.c(c1342h6D.z().a())) && Arrays.equals(c1342h6D.C().a(), Build.VERSION.SDK.getBytes())) {
                                                Vy vy2 = this.d;
                                                byte[] bArr4 = this.f10727k;
                                                String str = new String(c1342h6D.z().a());
                                                vy2.getClass();
                                                byte[] bArrA2 = Vy.a(str, bArr4);
                                                file5.createNewFile();
                                                ...
                                                try {
                                                    ...
                                                    e(fileInputStream);
                                                    e(fileOutputStream);
                                                } catch (Uy | IOException | NullPointerException unused) {
                                                    e(fileInputStream);
                                                    e(fileOutputStream);
                                                } catch (Throwable th3) {
                                                    th = th3;
                                ...
                                } catch (Uy | IOException | NullPointerException unused2) {
                                    fileOutputStream = null;
                                }
                            }
                        } catch (Uy | IOException | NullPointerException unused3) {
                ...
                try {
                    this.f10728l = new DexClassLoader(file2.getAbsolutePath(), this.f10725i.getAbsolutePath(), null, this.f10718a.getClassLoader());
                    for (Yy yy : this.f10722f) {
                        Pair pairCreate = Pair.create(yy.f11140a, yy.f11141b);
                        HashMap map = this.f10723g;
                        if (!map.containsKey(pairCreate)) {
                            map.put(pairCreate, this.f10719b.submit(new CallableC1987t6(11, this, yy)));
                        }
                    }
                    this.f10726j = true;
                    c1506kAA.c();
                    ...
                    d(file2);
                    File file6 = this.f10725i;
                    c(file6);
                    d(new File(String.format("%s/%s.dex", file6, "1779306227211")));
                }
            } catch (Uy | IOException | NullPointerException e9) {
                throw new C1118cy(e9);
            }
        } catch (Throwable th6) {
            c1506kAC.c();
            throw th6;
    ...
    public final Method b(String str, String str2) {
        Future future = (Future) this.f10723g.get(new Pair(str, str2));
        C1560lA c1560lA = this.f10721e;
        if (future == null) {
            c1560lA.b(302);
            return null;
        }
        try {
            return (Method) future.get(this.f10724h, TimeUnit.MILLISECONDS);
